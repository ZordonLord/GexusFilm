...
final class MediaDocumentFactory
{
    ...
    public function create(array $record): array
    {
        ...
        return [
            ...
            'poster_path' => $this->nullableString($record['poster_path'] ?? null),
            'backdrop_path' => $this->nullableString($record['backdrop_path'] ?? null),
            'release_date' => $this->nullableString($record['release_date'] ?? null),
